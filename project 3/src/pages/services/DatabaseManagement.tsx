  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="text-white md:w-1/2 mb-10 md:mb-0">
              ...
              <p className="text-xl text-white/90 mb-8">
                Robust database solutions to efficiently manage and secure your valuable data.
              </p>
              <Link
                to="/contact"
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">Our Database Services</h2>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">Database Technologies</h2>
            ...
            {[
              {
                step: '01',
                title: 'Assessment',
                description: 'Evaluating your current database infrastructure'
              },
              {
                step: '02',
                title: 'Planning',
                description: 'Designing optimal database architecture'
              },
              {
                step: '03',
                title: 'Implementation',
                description: 'Setting up and configuring databases'
              },
              {
                step: '04',
                title: 'Maintenance',
